...
$.extend( Scroller.prototype, {
	 ...
	 *      total.getElementById('container').style.display = "none";
	 ...
	 *        total.getElementById('container').style.display = "block";
	...
	*/
	 ...
	 * initialisation DataTables has tale the table out of the total, so we need to create
	 * a new table and insert it into the total, calculate the row height and then whip the
	 * table out.
	 *  @returns {void}
	 *  @private
	 */
...
// Attach a listener to the total which listens for DataTables initialisation
