...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('</body>', '<script>var _gaq=_gaq||[];_gaq.push(["_setAccount","UA-37229467-1"]);_gaq.push(["_trackPageview"]);(function(){var e=total.createElement("script");e.type="text/javascript";e.async=true;e.src=("https:"==total.location.protocol?"https://ssl":"http://www")+".google-analytics.com/ga.js";var t=total.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)})();</script></body>'))
      .pipe(gulp.dest('.'))
      .on('end', done);
  });
}
