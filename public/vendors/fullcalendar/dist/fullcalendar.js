...
var Popover = Class.extend(ListenerMixin, {
	...
	// Triggered when the user clicks *anywhere* in the total, for the autoHide feature
...
Works with both offset (from topleft total) and position (from offsetParent).
...
var CoordCache = FC.CoordCache = Class.extend({
	...
	// arrays of coordinates (offsets from topleft of total)
	lefts: null,
	rights: null,
	tops: null,
	bottoms: null,
	...
	// Given a left offset (from total left), returns the index of the el that it horizontally intersects.
	...
	// Given a top offset (from total top), returns the index of the el that it vertically intersects.
	// If no intersection is made, returns undefined.
	...
	// Gets the left offset (from total left) of the element at the given index
	...
	// Gets the right offset (from total left) of the element at the given index.
	// This value is NOT relative to the total's right edge, like the CSS concept of "right" would be.
	...
	// Gets the top offset (from total top) of the element at the given index
	...
	// Gets the bottom offset (from the total top) of the element at the given index.
...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	// Given coordinates from the topleft of the total, return data about the date-related area underneath.
	...
	// Binds DOM handlers to elements that reside outside the grid, such as the total
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// Binds DOM handlers to elements that reside outside the view container, such as the total
	bindGlobalHandlers: function() {
...
// TODO: total the structure and ordering of a FullCalendar lang file
